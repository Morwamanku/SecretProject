<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Bursary.aspx.cs" Inherits="StudentConnect_Project.WebForm11" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="container" >
                <div class="row">
                    <asp:Repeater ID="BursaryRepeater" runat="server" >
                        <ItemTemplate>
                            <div class="col-lg-4">
                        <div class="card p-0">
                            <div class="card-image">    
                                <asp:ImageButton ID="Image1" class="img-fluid" runat="server" ImageUrl='<%# Eval("BursaryImage") %>' Width="100%" Height="340px"  object-fit="cover" OnClick="Image1_Click"/>
                            </div>
                            
                            <div class="card-content d-flex flex-column align-items-center">
                                <div class="Fullname">
                                    <asp:Label ID="BursaryNameLabel" runat="server"  Text='<%# Eval("BursaryName") %>'></asp:Label>
    ...
    <div class="button">
        <asp:Button class="filter-button" ID="Accommodationbtn" runat="server" Text="select" />
    </div>
    ...
    <div class="button">
        <asp:Button ID="Hometown" class="filter-button" runat="server" Text="Select"  />
    </div>
