...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="LeftNavigationStyle.css" rel="stylesheet" />
</asp:Content>
        ...
        <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card p-0 ">
                            <div class="card-image">
                                <img src="http://www.publicdomainpictures.net/pictures/170000/velka/portrait-of-a-woman-1463167149YVk.jpg"
                                    alt=""/>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card p-0">
                            <div class="card-image">
                                <img src="http://www.magnoliaeditions.com/wp-content/uploads/2012/03/Close-Self-Portrait.jpg"
                                    alt="">
                            </div>
                            <div class="card-content d-flex flex-column align-items-center">
                                <h4 class="pt-2">SomeOne Famous</h4>
                    ...
                    <div class="col-lg-4">
                        <div class="card p-0">
                            <div class="card-image">
                                <img src="https://i.pinimg.com/originals/2e/8e/58/2e8e5896af7b93ed1e674c23ba336353.jpg"
                                    alt=""/>
                            </div>
                            <div class="card-content d-flex flex-column align-items-center">
                                <h4 class="pt-2">SomeOne Famous</h4>
