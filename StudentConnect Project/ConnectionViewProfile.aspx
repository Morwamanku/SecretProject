<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ConnectionViewProfile.aspx.cs" Inherits="StudentConnect_Project.WebForm15" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:FormView ID="FormView2" runat="server">
        <ItemTemplate>
            ...
            <h3>Are you sure you would like to Disconnect</h3>
            
            <div class="Profile-buttons">
                <button class="p-btn" type="button" onclick="closePopup()">Back</button>
                <asp:Button ID="Disconnectbtn" class="connectbtn_done" CssClass="p-btn" runat="server" Text="Disconnect" OnClick="Disconnectbtn_Click"  />
            </div>
