            ...
            <div class="flex-wrapper" onclick="removenavigation()">
                ...
                <div class="Profile-container ">
                   ...
                   <h1><asp:Label ID="Label1" runat="server"  Text='<%# Eval("Firstname") %>'></asp:Label>
                    ...
                    <p style="height: 90px;">Im a cool dude that loves good food. I love technology. I would love be a software egineer and work for Amazon one day. I like cars and sports such as UFC </p>
                    <div class="content">
